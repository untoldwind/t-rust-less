...
pub mod ring {
  ...
  pub mod private_key {
    ...
    impl<'a> Builder<'a> {
      ...
      #[inline]
      pub fn set_nonce(&mut self, value: ::capnp::data::Reader) {
        self.builder.get_pointer_field(0).set_data(value);
      }
      #[inline]
      ...
      #[inline]
      pub fn set_crypted_key(&mut self, value: ::capnp::data::Reader) {
...
pub mod block {
  ...
  pub mod header {
    ...
    impl<'a> Builder<'a> {
      ...
      #[inline]
      pub fn set_common_key(&mut self, value: ::capnp::data::Reader) {
        self.builder.get_pointer_field(0).set_data(value);
      }
      #[inline]
